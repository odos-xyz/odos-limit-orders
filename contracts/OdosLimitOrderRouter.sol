...
contract OdosLimitOrderRouter is EIP712, Ownable, SignatureValidator {
  ...
  /// @notice Changes the address which can call `swapRouterFunds()` an `transferRouterFunds()` functions
  /// @param account The address to be assigned the Liquidator role
